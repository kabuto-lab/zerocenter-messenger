...
pub const DEFAULT_BOOTSTRAPS: &[&str] = &[
    // bootstrap-1 — VPS (RU), provisioned 2026-05-24. IP-pinned for
    // now; will move behind /dns4/bootstrap-1.me55.network once DNS
    // is set up so the node can be moved without rebuilding clients.
