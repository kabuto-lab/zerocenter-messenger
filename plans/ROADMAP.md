...
Living document tracking what's done, what's in flight, and what's queued. Last refreshed 2026-05-20 (OTPK serve/consume regression fixed mid-DM-testing).
...
- `fix/otpk-serve-consume-lifecycle` (b365be4) is committed but **not yet merged into `main`** — merge or open a PR before the next release tag.
